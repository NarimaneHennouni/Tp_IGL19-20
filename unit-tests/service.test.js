...
test('server should return questions',async ()=>
{
    ...
    expect(data).toEqual([{"id_qst":1,"id_user":5,"question":"c'est quoi docker ?"},{"id_qst":2,"id_user":8,"question":"à quoi sert selenium ?"},
    {"id_qst":3,"id_user":4,"question":"est-ce que la méthodologie scrum est une méthode agile ?"},{"id_qst":4,"id_user":14,"question":"peut-on utiliser mocha pour le unit testing ?"},
    {"id_qst":5,"id_user":0,"question":"is jsdoc used for automatic documentation ?"}]);
