/**
 * This file represents the home page of the documentation not the original one, but the personalised one (custom version)
 * @module custom-template/publish-js
 */
...
function buildNav(members) {
    let globalNav;
    let nav = '<h2><a href="index.html">name of the app</a></h2>';
    const seen = {};
    const seenTutorials = {};
...
exports.publish = (taffyData, opts, tutorials) => {
    ...
    generate('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div><br><img src="./description.jpg" alt="description" width="100%"/></div>',
        packages.concat(
            [{
                kind: 'mainpage',
                readme: opts.readme,
